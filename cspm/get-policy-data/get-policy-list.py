...
# Create CSV header
column_headers = ['name', 'cloud_provider', 'cloud_service_friendly', 'cloud_service', 'cloud_service_subtype']
...
for policy_details in policy_details_all["body"]["resources"]:
    policy_details_and_benchmark_ids = {key: value for key, value in policy_details.items() if "name" in key or "cloud_service" in key or "cloud_provider" in key}
